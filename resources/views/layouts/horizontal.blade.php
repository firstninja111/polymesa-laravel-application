            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user" src="{{ URL::asset(Auth::user()->avatar) }}"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium font-size-15">{{Str::ucfirst(Auth::user()->lastname). ' '. Str::ucfirst(Auth::user()->firstname)}}</span>
    ...
    <div class="container-fluid">
        <div class="topnav">
            ...
            <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                ...
                <div class="collapse navbar-collapse" id="topnav-menu-content" style="justify-content: flex-end;">
                    <ul class="navbar-nav">
                        
                        @if(Auth::user()->role == "admin")
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('admin-unapproved-medias')}}">
                                <i class="far fa-file-excel me-2"></i> @lang('translation.UnapprovedMedias')
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('categories')}}">
                                <i class="fas fa-thumbtack me-2"></i> @lang('translation.Categories')
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('settings')}}">
                                <i class="fas fa-book me-2"></i> @lang('translation.Settings')
                            </a>
                        </li>                     
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('user-dashboard')}}">
                                <i class="fas fa-home me-2"></i> @lang('translation.Dashboard')
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('user-statistics')}}">
                                <i class="far fa-chart-bar me-2"></i> @lang('translation.Statistics')
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('upload')}}">
                                <i class="fas fa-upload me-2"></i> @lang('translation.Upload')
                            </a>
                        </li>
                        <li class="nav-item">
